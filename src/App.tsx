...
function App() {
  ...
  const updatePreviewScale = useCallback(() => {
    ...
    setPreviewScale(Math.min(1, width / 800));
  }, []);
            ...
            <div className="flex items-center gap-3 sm:gap-6">
              ...
              <nav className="flex gap-1">
                ...
                <button
                  ...
                  className={`px-2 sm:px-3 py-1.5 text-xs sm:text-sm rounded-md transition-colors flex items-center gap-1.5 ${
                    view === 'list'
                      ? 'bg-neutral-100 dark:bg-neutral-800 text-neutral-900 dark:text-white'
                      : 'text-neutral-500 hover:text-neutral-900 dark:hover:text-white'
                  }`}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="lg:sticky lg:top-20 h-fit order-1 lg:order-2">
              ...
              <div
                ...
                className="overflow-hidden max-h-[60vh] lg:max-h-[calc(100vh-10rem)] rounded-lg border border-neutral-200 dark:border-neutral-800 bg-white"
              >
                <div
                  className="overflow-auto origin-top-left"
                  style={{
                    zoom: previewScale < 1 ? previewScale : undefined,
                    maxHeight: previewScale < 1 ? `${60 / previewScale}vh` : undefined,
                  }}
                >
                  <InvoicePreview
                    ref={previewRef}
              ...
              {/* Mobile action bar */}
              <div className="flex sm:hidden items-center gap-2 mt-2 no-print overflow-x-auto pb-1">
                <button
                  onClick={shareViaEmail}
                  className="flex items-center gap-1.5 px-3 py-2 text-xs border border-neutral-200 dark:border-neutral-700 rounded-lg text-neutral-600 dark:text-neutral-400 shrink-0"
                >
                ...
                <button
                  onClick={downloadImage}
                  disabled={isGenerating}
                  className="flex items-center gap-1.5 px-3 py-2 text-xs border border-neutral-200 dark:border-neutral-700 rounded-lg text-neutral-600 dark:text-neutral-400 shrink-0 disabled:opacity-50"
                >
                  <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                  </svg>
